...
### Action Types [GDD.CORE.TIME.ACTION_TYPES]
...
- **Focus Limit:** 5 * MEN
- **Floating Mana Limit:** 5 * MEN

## Resources [GDD.CORE.RESOURCES]

List of resources used in the game.

### Mana [GDD.CORE.RESOURCES.MANA]
...
### Focus [GDD.CORE.RESOURCES.FOCUS]
[DEPENDS: GDD.CORE.ATTR.MEN, GDD.CORE.TIME.ACTION_TYPES]
...
### Hit Points (PV)[GDD.CORE.RESOURCES.PV]
...
- **Disadvantage [GDD.COMBAT.FLOW.DSV]:** Rolling with disadvantage means rolling two dice and choosing lower value.
...
- **Magical Focus [GDD.EQUIP.TYPES.WEAPONS.MAGICAL]:** Objects used as arcane focus, such as Staves, Orbs, or Grimoires.

### Armor Types[GDD.EQUIP.TYPES.ARMORS]
- **Robe [GDD.EQUIP.TYPES.ARMORS.ROBE]:** Robes and vestments inbued with magic that casters and some fighters use.
- **Light [GDD.EQUIP.TYPES.ARMORS.LIGHT]:** Lightweight armor that offers some protection, but still allows a good mobility.
- **Heavy [GDD.EQUIP.TYPES.ARMORS.HEAVY]:** Heavy armor that offers a lot of protection, but limits mobility.
...
## Definition [GDD.STYLES.DEFINITION]
...
[ARCH.DOC.views.BattleView]Defense rolls are at disadvantage until start of next turn.
