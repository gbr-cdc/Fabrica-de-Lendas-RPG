...
- EFFECT_HOOK_BUILDERS [ARCH.DOC.battle.BattleActions.GLOBAL:EFFECT_HOOK_BUILDERS]: Extensible registry of builders for action-specific effects. Includes: `add_gda`, `swap_atk_def_die`, `set_gda_zero_on_dmg`, and `apply_status_on_hit_threshold`.
