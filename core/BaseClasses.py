...
class IControllerContext(IRegistryContext, ITimelineContext, IEffectContext, Protocol): ...

class IJudgeContext(IRegistryContext, ITimelineContext, Protocol): ...

class IBattleContext(IEventContext, IEffectContext, ITimelineContext, IRegistryContext, IDiceContext, IActionStateContext, Protocol): ...
